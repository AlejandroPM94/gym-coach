        ...
        return AthleteProfileView.model_validate(
            {
                ...
                "sex_for_energy_equation": row.sex_for_energy_equation or "unspecified",
                ...
                "occupation_activity": row.occupation_activity,
                "average_daily_steps": row.average_daily_steps,
                ...
                "nutrition_preferences": row.nutrition_preferences,
                "nutrition_tracking_preference": row.nutrition_tracking_preference,
                "health_conditions": row.health_conditions,
                "medications_affecting_training": row.medications_affecting_training,
                "lifestyle_reviewed": row.lifestyle_reviewed,
                "nutrition_reviewed": row.nutrition_reviewed,
                "health_reviewed": row.health_reviewed,
            }
        )
